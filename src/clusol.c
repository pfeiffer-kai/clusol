...
void clu1fac(
  ...
  int64_t* n2,
  int64_t* np) {
  __lusol_MOD_lu1fac(m,n,nelem,lena,luparm,parmlu,a,indc,indr,p,q,lenc,lenr,locc,locr,iploc,iqloc,ipinv,iqinv,w,inform,n1,n2,np);
}
...
void clu8rpcsparse(
  ...
  double* vnorm,
  int64_t* lmin) {
  __lusol_MOD_lu8rpcsparse(mode1,mode2,m,n,jrep,v,w,lena,luparm,parmlu,a,indc,indr,p,q,lenc,lenr,locc,locr,inform,diag,vnorm,lmin);
}
